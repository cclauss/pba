...
CUDA_VISIBLE_DEVICES=0 ./scripts/svhn.sh reduced_cifar_10/16_wrn rsvhn_cifarpol_wrn_2810 wrn_28_10 0.05 0.05 160 |& tee rsvhn_cifarpol_wrn2810.txt
CUDA_VISIBLE_DEVICES=0 ./scripts/svhn.sh svhn/svhn_2_23_b_policy_15 rsvhn_svhnpol_ss96 shake_shake_96 0.005 0.005 160 |& tee rsvhn_svhnpol_ss96.txt
CUDA_VISIBLE_DEVICES=0 ./scripts/svhn.sh svhn/svhn_2_23_b_policy_15 rsvhn_svhnpol_ss96 shake_shake_96 0.005 0.005 1760 |& tee rsvhn_svhnpol_ss96.txt

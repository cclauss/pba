...
#bair, c66, c75 CUDA_VISIBLE_DEVICES=0 ./scripts/eval-wrn.sh 0 1 11-23_tuned_bair_policy_2 |& tee eval_logs/11-23_tuned_bair_policy_2.txt
#bair CUDA_VISIBLE_DEVICES=0 ./scripts/eval-wrn.sh 5 0 11-23_tuned_bair_policy_2 |& tee eval_logs/11-23_tuned_bair_policy_2_small.txt

#c69 CUDA_VISIBLE_DEVICES=0 ./scripts/eval-wrn.sh 5 1 11-23_tuned_c66_policy_3 |& tee eval_logs/11-23_tuned_c66_policy_3.txt
#blaze, c80 CUDA_VISIBLE_DEVICES=0 ./scripts/eval-wrn.sh 0 1 11-23_tuned_c66_policy_3 |& tee eval_logs/11-23_tuned_c66_policy_3.txt

#blaze CUDA_VISIBLE_DEVICES=5,6,7 ./scripts/eval-wrn.sh 5 3 11-23_tuned_c69_policy_4 |& tee eval_logs/11-23_tuned_c69_policy_4.txt

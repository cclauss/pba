...
MEANS = {'cifar10_50000':[0.49139968, 0.48215841, 0.44653091],
         ...
         'svhn_1000':[0.43705846, 0.4444715, 0.47642156]}
STDS = {'cifar10_50000':[0.24703223, 0.24348513, 0.26158784],
        ...
        'svhn_1000': [0.19806475, 0.20167638, 0.19955956]}
...
def _crop_impl(pil_img, level=None, interpolation=Image.BILINEAR):
    """Applies a crop to `pil_img` with the size depending on the `level`."""
    cropped = pil_img.crop(
        (level, level, IMAGE_SIZE - level, IMAGE_SIZE - level))
